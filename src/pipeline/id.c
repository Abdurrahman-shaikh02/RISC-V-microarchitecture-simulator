...
int set_hazard_stall(){
	...
	if(ex_ma.cs_wb.wb == 1){
		if((id_ex.cs_ex.source1 == 1 && ex_ma.nrd == id_ex.nrs1 && id_ex.nrs1 != 0) ||	
	...
	if(ma_wb.cs_wb.wb == 1){
		if((id_ex.cs_ex.source1 == 1 && ma_wb.nrd == id_ex.nrs1 && id_ex.nrs1 != 0) ||
	...
	if(wb_if.cs_wb.wb == 1){
		if((id_ex.cs_ex.source1 == 1 && wb_if.nrd == id_ex.nrs1 && id_ex.nrs1 != 0) ||
		(id_ex.cs_ex.source2 == 0 && wb_if.nrd == id_ex.nrs2 && id_ex.nrs2 != 0) ||
