...
void replace(uint32_t addr, cache_line * cache, int size, int block_size, int n_way){
...
void replace_fifo(uint32_t addr, cache_line * cache, int size, int block_size, int n_way){

}

void replace_lru(uint32_t addr, cache_line * cache, int size, int block_size, int n_way){
